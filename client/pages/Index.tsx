  ...
  return (
      ...
      <div className="min-h-screen relative">
        ...
        <div className="absolute bottom-8 right-8 z-20">
          <Link
            to="/contact"
            className="inline-block bg-black/80 backdrop-blur-sm text-white font-gotham-medium px-6 py-3 rounded-sm hover:bg-black transition-all duration-300 shadow-lg hover:shadow-xl"
          >
            GET IN TOUCH
          </Link>
        </div>
