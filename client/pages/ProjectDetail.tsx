...
export default function ProjectDetail() {
  ...
  const projectTitle = id ? projectNames[id] || id.replace(/-/g, ' ') : 'Project';
          ...
          <div className="max-w-[1200px] mx-auto px-4">
            <div className="pt-[60px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div>
                  <h3 className="text-xl font-gotham-medium mb-4 text-black">Project Overview</h3>
                  <p className="text-gray-600 leading-relaxed mb-6">
                    This project page is currently under development. 
                    Continue prompting to add detailed information about this architectural project, 
                    including project specifications, design philosophy, materials, and construction details.
                  </p>
                  
                  <h3 className="text-xl font-gotham-medium mb-4 text-black">Project Details</h3>
                ...
                <div>
                  <h3 className="text-xl font-gotham-medium mb-4 text-black">Design Approach</h3>
                  <p className="text-gray-600 leading-relaxed mb-6">
                    Detailed information about the design approach, architectural concepts, 
                    and creative vision for this project will be added here. 
                    This section will showcase the innovative solutions and design thinking 
                    that defines Studio Yona's approach to architecture.
                  </p>
                  
                  <h3 className="text-xl font-gotham-medium mb-4 text-black">Awards & Recognition</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Project recognition and awards will be listed here once content is added.
                  </p>
                </div>
              </div>
            </div>
