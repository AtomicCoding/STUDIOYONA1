...
export default function ProjectDetail() {
  ...
  return (
    <>
      <title>Project - Studio Yona</title>
      ...
      <div className="min-h-screen">
        ...
        <div className="relative z-10 bg-white min-h-[calc(100vh-90px)] py-20">
          <div className="max-w-[1200px] mx-auto px-4">
            <div className="text-center">
              <h1 className="text-4xl font-gotham-medium mb-8 capitalize">
                {id?.replace(/-/g, ' ') || 'Project'}
              </h1>
              <p className="text-lg text-gray-600 mb-8">
                This project page is under construction. Continue prompting to add detailed content for this project.
              </p>
              <Link 
                to="/projects"
                className="text-black font-gotham-medium text-sm transition-all duration-300 ease-linear hover:opacity-70 underline"
              >
                ← Back to Projects
              </Link>
            </div>
