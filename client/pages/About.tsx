...
export default function About() {
  return (
    <>
      <title>About - Woods + Dangaran</title>
      ...
      <div className="min-h-screen relative">
        ...
        <div className="relative z-10 bg-white min-h-[calc(100vh-90px)] py-20">
          <div className="max-w-[1200px] mx-auto px-4">
            <div className="text-center">
              <h1 className="text-4xl font-gotham-medium mb-8">About</h1>
              <p className="text-lg text-gray-600 mb-8">
                This page is under construction. Continue prompting to add content for the About section.
              </p>
            </div>
          </div>
        </div>
